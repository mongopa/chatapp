...
//        mDatabase = FirebaseDatabase.getInstance().reference
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot?) {
                ...
                if (!image!!.equals("default")){
                    Picasso.with(applicationContext).load(image)
                            .placeholder(R.drawable.profile_img).into(settingsProfileID)
                }
            }
        ...
        setteingsChangeStatusBtn.setOnClickListener {
        ...
        settingsChangeImgBtn.setOnClickListener {
            ...
            startActivityForResult(Intent.createChooser(galleryIntent,"SELLECT_IMAGE"),GALLARY_ID)
        }
    }

    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode ==GALLARY_ID &&resultCode == Activity.RESULT_OK){
        ...
        if (requestCode === CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if(resultCode === Activity.RESULT_OK){
                ...
                //画像圧縮
                var thumbBitmap = Compressor(this).setMaxWidth(200).setMaxHeight(200)
                        .setQuality(65).compressToBitmap(thumbFile)
                        ...
                        uploadTask.addOnCompleteListener {
                            ...
                            if (task.isSuccessful){
                                ...
                                mDatabase!!.updateChildren(updateObj).addOnCompleteListener {
                                    task: Task<Void> ->
                                    if (task.isSuccessful){
                                        Toast.makeText(this,"プロフィール写真を保存しました",
