...
import xyz.mongop.chatapp.models.FriendlyMessage
...
//        以下挿入
                                ...
                                .addValueEventListener(object:ValueEventListener{
                                    override fun onDataChange(data: DataSnapshot?) {
                                        ...
                                        Picasso.with(viewHolder.profileImageView!!.context)
                                                .load(imageUrl).placeholder(R.drawable.profile_img)
    ...
    class MessageViewHolder(itemView:View):RecyclerView.ViewHolder(itemView){
        ...
        fun bindView(friendlyMessage: FriendlyMessage){
            ...
            profileImageView = itemView.findViewById(R.id.messengerImamgeView)
            profileImageViewRight = itemView.findViewById(R.id.messengerImamgeViewRight)
